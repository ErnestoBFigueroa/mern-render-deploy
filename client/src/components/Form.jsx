...
export default function Form( {setUser} ) {
    ...
    function valida(){
        if(email === "" || password ==="" || checkSistema ===""){
            setError(true)            
            return
        } else{
            setUser([email]);            
    ...
    return (
        <div className='w-[90%] max-w-lg mx-auto bg-white px-10 py-1 rounded-3xl border-2 border-gray-100'>
            <h1 className='text-5xl font-semibold pt-8'>Bienvenido</h1>
            ...
            <div className='mt-8'>
                ...
                <div className='mt-4 flex justify-center items-center'>
                    <p className='font-semibold text-base'>Aun no tienes cuenta?</p>
                    {/* <button className='text-violet-500 text-base font-medium ml-2'>Sign up</button> */}
                    <Link className='text-violet-500 text-base font-medium ml-2'
